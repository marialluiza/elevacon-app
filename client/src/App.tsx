      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route element={<PrivateRoute allowedRoles={['CONTADOR', 'CLIENTE']} />}>
            ...
            <Route path="/ListaDocumentosEnviados" element={<ListaDocumentosEnviados />} />
          ...
          <Route element={<PrivateRoute allowedRoles={['CONTADOR']} />}>
            ...
            <Route path="/ListarTiposDocumentos/" element={<ListaTiposDocumetos />} />

          </Route>

          <Route element={<PrivateRoute allowedRoles={['CLIENTE']} />}>
            <Route path="/VisualizarClienteCliente" element={<VisualizarInformaçõesLadoCliente />} />
            <Route path="/EditarClienteCliente" element={<EditarClienteCliente />} />
          </Route>
