        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="p-4 md:p-5">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center space-x-2">
                <input type="text" readOnly value={password || "Senha não gerada"} className="w-full p-2.5 border border-gray-300 rounded-lg text-gray-900 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
