...
public class TokenService {
    ...
    // 'Secret' é um dado sensível (como senhas ou chaves API) usado para proteger a
    ...
    public String geraToken(Usuario usuario) {
        try {
            // recebe por parametro uma secret, que é o que torna os hashs unicos -> a
            // secret não fica armazenada no código e atua como algo único do nosso código
